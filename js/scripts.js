  ...
  'use strict';
    ...
    if ($('.pagepiling').length > 0){
		...
		/* Hide Mobile Menu On Anchor Click*/
			...
			$('.menu-pagepiling ul li a, .menu-lang a').on('click', function() { 
		   	   hideMenu();
		    });	
	...
	$(document).ready(function() {
		...
		// Initial language setting (assuming 'geo' is the default)
		var currentLanguage = 'geo';
	
		// Click event handler for language links
	...
	$(document).ready(function () {
		// Function to toggle language
		function toggleLanguage(language) {
			$('.menu .nav.mobile-menu .menu-list a[data-lang="' + language + '"]').toggle();
		}
		
		// Initial language setting (assuming 'geo' is the default)
		var currentLanguage = 'geo';
		
		// Click event handler for language links in the sidebar
		$('#language-links a').click(function (e) {
			e.preventDefault();
	...
	$(document).ready(function() {
        $(".copy-email").click(function() {
            ...
            var tempInput = $("<input>");
            tempInput.val(email).appendTo("body").select();
